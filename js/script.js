...
const helpContent = {
	shellType: {
		...
		body: 'Chọn loại pháo hoa sẽ bắn ra. Chọn "Ngẫu nhiên" là một lựa chọn tốt!'
	},
	shellSize: {
		header: 'Kích thước pháo hoa',
		body: 'Kích thước pháo hoa: mô phỏng kích thước thực tế của pháo hoa, kích thước lớn hơn có sức nổ mạnh hơn, có nhiều sao hơn, và đôi khi có hiệu ứng phức tạp hơn. Tuy nhiên, kích thước lớn hơn cần xử lý nhiều hơn và có thể gây trễ.'
	},
	quality: {
		header: 'Chất lượng hình ảnh',
		body: 'Chất lượng đồ họa tổng thể. Nếu hoạt hình không chạy mượt mà, hãy thử giảm chất lượng. Chất lượng cao sẽ tăng đáng kể số lượng tia lửa tạo ra và có thể gây trễ.'
	},
	skyLighting: {
		header: 'Ánh sáng bầu trời',
		body: 'Chiếu sáng nền khi pháo hoa nổ. Nếu nền trên màn hình trông quá sáng, hãy thử đặt thành "Mờ" hoặc "Không".'
	},
	scaleFactor: {
		header: 'Tỉ lệ',
		body: 'Cho phép thu phóng kích thước của tất cả pháo hoa, về cơ bản làm cho bạn nhìn gần hoặc xa hơn. Đối với các loại pháo hoa lớn hơn, có thể giảm tỉ lệ một chút, đặc biệt là trên điện thoại hoặc máy tính bảng.'
	},
	autoLaunch: {
		header: 'Khởi chạy tự động',
		body: 'Bật tùy chọn này để tự động khởi động chuỗi pháo hoa, bỏ chọn bạn có thể điều khiển bắn pháo hoa thủ công.'
	},
	finaleMode: {
		header: 'Chế độ kết thúc',
		body: 'Bắn pháo hoa mạnh mẽ. Có thể gây trễ. Cần phải bật đồng thời "Khởi chạy tự động".'
	},
	hideControls: {
		header: 'Ẩn bộ điều khiển',
		body: 'Ẩn các điều khiển trong suốt ở đầu màn hình. Hữu ích cho chụp màn hình, hoặc chỉ là một trải nghiệm liền mạch hơn. Sau khi ẩn, bạn vẫn có thể nhấp vào góc trên bên phải để mở lại menu này.'
	},
	fullscreen: {
	...
	longExposure: {
		header: 'Phơi sáng lâu',
		body: 'Hiệu ứng thử nghiệm có thể giữ lại ánh sáng trong thời gian dài, giống như giữ cho cửa trập máy ảnh mở.'
	}
};
...
const shellTypes = {
	...
	'Pháo lân': crackleShell,
	'Pháo hoa xòe': crossetteShell,
	'Pháo hoa cúc': crysanthemumShell,
	'Pháo hoa lá rụng': fallingLeavesShell,
	'Pháo hoa hoa': floralShell,
	'Pháo hoa ma': ghostShell,
	'Pháo hoa đuôi ngựa': horsetailShell,
	'Pháo hoa cọ': palmShell,
	'Pháo hoa vành': ringShell,
	'Pháo hoa chớp': strobeShell,
	'Pháo hoa liễu': willowShell
};
